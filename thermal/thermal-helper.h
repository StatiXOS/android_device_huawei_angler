...
constexpr unsigned int kBatterySensorNum = 23;
// fix me i want to an array actuall cpusensors are 8, 9, 10, 11, 14, 15, 16, 7
constexpr unsigned int kCpuSensorNum = 7;
constexpr unsigned int kGpuSensorNum = 13;
constexpr unsigned int kSkinSensorNum = 18;

constexpr unsigned int kCpuNum = 8;
constexpr unsigned int kTemperatureNum = 11;
...
constexpr unsigned int kSkinTrottlingThreshold = 41;
