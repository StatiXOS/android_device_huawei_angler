...
# Audio
PRODUCT_COPY_FILES += \
    device/huawei/angler/audio/audio_output_policy.conf:system/etc/audio_output_policy.conf \
    device/huawei/angler/audio/audio_effects.conf:system/etc/audio_effects.conf \
